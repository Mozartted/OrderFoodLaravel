                                        ...
                                        <table class="table table-hover table-bordered">
                                            ...
                                            @foreach($features as $feature)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="label label-sm label-success">{!! $feature->percent !!}</span></td>
                                                    @if(Auth::user()->usergroup->name=='Admin')
                                                        <td><a href="{{url('administrator/feature/'.$feature->id.'/edit')}}">Edit</a> | {!! Form::open(['method' => 'DELETE', 'route' => ['feature.delete', $feature->id]]) !!}
