                                ...
                                <div class="col-lg-12">
                                    <div class="panel panel-blue" style="background:#fff;">
                                        ...
                                        <div class="panel-body pan">
                                            {!! Form::model($post,['url' => '/administrator/blog/'.$post->id.'/update','method' => 'put','files' => 'true']) !!}
                                            <div class="form-body pal">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div><img src="{{asset($post->image)}}" alt="" title="" style="height: 200px; width: 250px; background-size: contain"/></div>
                                                        <div class="form-group">
