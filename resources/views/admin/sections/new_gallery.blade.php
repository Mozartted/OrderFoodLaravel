...
@section('content')
    <div id="page-wrapper">
        @include('admin.sections.partials.users_header',['header'=>'New Gallery Post'])
                                ...
                                <div class="col-lg-12">
                                    <div class="panel panel-blue" style="background:#fff;">
                                        ...
                                        <div class="panel-body pan">
                                            {!! Form::open(['route'=>'new_gallery','files' => 'true']) !!}
                                            <div class="form-body pal">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-group">
                                                            {!!Form::label('image', 'Select A Gallery Post Image, something nice!!!')!!}
                                                            {!!Form::file('image')!!}
