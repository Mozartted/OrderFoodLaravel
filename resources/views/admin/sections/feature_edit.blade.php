...
@section('content')
    <div id="page-wrapper">
        @include('admin.sections.partials.users_header',['header'=>'Feature'])
                ...
                <div class="row mbl">
                    ...
                    <ul id="generalTab" class="nav nav-tabs responsive">
                        @if(Auth::user()->usergroup->name=='Admin')
                            <li class="active"><a href="#note-tab" data-toggle="tab">Add Feature</a></li>
                        @endif
                    </ul>
                            ...
                            <div class="row">
                                <div class="panel panel-orange">
                                    ...
                                    <div class="panel-body pan">
                                        {!! Form::model($feature,['url' => '/administrator/feature/'.$feature->id.'/update','method' => 'put']) !!}
